...
<head>
    ...
    <title>{{ App\Models\Setting::get('church_name', 'Grace Church') }}</title>
...
<body>
    ...
    <nav class="glass-nav py-4 px-6 md:px-12 flex justify-between items-center">
        ...
        <div class="flex items-center gap-6">
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="btn-gold text-sm py-2 px-6">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="text-sm font-medium hover:text-gold-bright transition-colors">Login</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn-gold text-sm py-2 px-6">Join Us</a>
                    @endif
                @endauth
            @endif
        </div>
    ...
    <header class="hero-section px-4">
        <div class="max-w-4xl mx-auto" style="animation: fadeInUp 1s ease-out;">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('login') }}" class="btn-outline">Member Access</a>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="sermon-card group">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('login') }}" class="text-xs font-bold text-gold-bright border-b border-gold-bright/30 pb-1">Listen Now</a>
                    </div>
                </div>
                ...
                <div class="sermon-card group">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('login') }}" class="text-xs font-bold text-gold-bright border-b border-gold-bright/30 pb-1">Event Details</a>
                    </div>
                </div>
                ...
                <div class="sermon-card group">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('login') }}" class="text-xs font-bold text-gold-bright border-b border-gold-bright/30 pb-1">Get Involved</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 px-6 md:px-12 bg-panel relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('register') }}" class="btn-gold">Create an Account</a>
    ...
    <footer>
        ...
        <div class="pt-8 border-t border-white/5 opacity-30 text-[10px] uppercase tracking-widest">
            &copy; {{ date('Y') }} {{ App\Models\Setting::get('church_name', 'Grace Church') }}. All rights reserved.
        </div>
    </footer>
