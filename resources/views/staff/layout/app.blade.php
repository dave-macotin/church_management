...
<head>
    ...
    <title>@yield('title', App\Models\Setting::get('church_name', 'Grace Church') . ' — Staff')</title>
...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('staff.members.index') }}" class="nav-item {{ request()->routeIs('staff.members.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.families.index') }}" class="nav-item {{ request()->routeIs('staff.families.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.groups.index') }}" class="nav-item {{ request()->routeIs('staff.groups.*') ? 'active' : '' }}">
                <span class="nav-icon"><svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg></span>
                <span class="nav-label">Groups</span>
            </a>

            <div class="nav-section-label">Ministry</div>
            <a href="{{ route('staff.events.index') }}" class="nav-item {{ request()->routeIs('staff.events.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.attendance.index') }}" class="nav-item {{ request()->routeIs('staff.attendance.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.sermons.index') }}" class="nav-item {{ request()->routeIs('staff.sermons.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.checkin.kiosk') }}" class="nav-item {{ request()->routeIs('staff.checkin.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.volunteering.index') }}" class="nav-item {{ request()->routeIs('staff.volunteering.*') ? 'active' : '' }}">
    ...
    <div class="main-area">
        <header class="topbar">
            ...
            <span class="topbar-title">@yield('page_title', 'Staff Portal')</span>
