...
<head>
    ...
    <title>@yield('title', App\Models\Setting::get('church_name', 'Grace Church') . ' — CMS')</title>
...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.sermons.index') }}" class="nav-item {{ request()->routeIs('admin.sermons.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.checkin.kiosk') }}" class="nav-item {{ request()->routeIs('admin.checkin.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.volunteering.index') }}" class="nav-item {{ request()->routeIs('admin.volunteering.*') ? 'active' : '' }}">
