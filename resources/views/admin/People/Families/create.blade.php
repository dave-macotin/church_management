...
@section('title', 'Add Family — Grace Church CMS')
    ...
    <form method="POST" action="{{ route('admin.families.store') }}">
        ...
        <div class="flex flex-col gap-4">
            <div>
                ...
                <input type="text" name="FamilyName" value="{{ old('FamilyName') }}" class="form-input" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="HomeAddress" value="{{ old('HomeAddress') }}" class="form-input">
            </div>
            <div>
