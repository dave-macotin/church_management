...
@section('title', 'Members — Grace Church CMS')
...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.members.create') }}" class="btn btn-gold">
...
<form method="GET" class="flex gap-3 mb-5">
    ...
    @if(request('search') || request('status'))
        <a href="{{ route('admin.members.index') }}" class="btn btn-ghost">Clear</a>
    @endif
</form>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center gap-2 justify-end">
                            <a href="{{ route('admin.members.edit', $member) }}" class="btn btn-ghost btn-sm">Edit</a>
                            <form method="POST" action="{{ route('admin.members.destroy', $member) }}"
                                  onsubmit="return confirm('Delete {{ $member->FirstName }} {{ $member->LastName }}?')">
                                @csrf @method('DELETE')
