...
@section('title', 'Add Group — Grace Church CMS')
    ...
    <form method="POST" action="{{ route('admin.groups.store') }}">
        ...
        <div class="flex flex-col gap-4">
            <div>
                ...
                <input type="text" name="GroupName" value="{{ old('GroupName') }}" class="form-input" required>
            </div>
            <div>
                <label class="form-label">Description</label>
                <textarea name="Description" rows="3" class="form-input" style="resize:vertical">{{ old('Description') }}</textarea>
            </div>
            <div>
