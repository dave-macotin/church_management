...
class GroupController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.People.Groups.index', compact('groups'));
    }

    public function create()
    {
        $events = Event::orderBy('StartDateTime', 'desc')->get();
        return view('admin.People.Groups.create', compact('events'));
    }
    ...
    public function show(Group $group)
    {
        ...
        return view('admin.People.Groups.show', compact('group'));
    }

    public function edit(Group $group)
    {
        $events = Event::orderBy('StartDateTime', 'desc')->get();
        return view('admin.People.Groups.edit', compact('group', 'events'));
    }
