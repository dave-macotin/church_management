...
<?php $__env->startSection('title', 'Edit Family — Grace Church CMS'); ?>
...
<div class="card p-6 max-w-xl">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.families.update', $family)); ?>">
        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
        <div class="flex flex-col gap-4">
            <div>
                <label class="form-label">Family Name <span style="color:var(--red)">*</span></label>
                <input type="text" name="FamilyName" value="<?php echo e(old('FamilyName', $family->FamilyName)); ?>" class="form-input" required>
            </div>
            <div>
                ...
                <select name="MemberID" class="form-input">
                    ...
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($member->MemberID); ?>" <?php echo e(old('MemberID', $family->MemberID) == $member->MemberID ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <input type="text" name="HomeAddress" value="<?php echo e(old('HomeAddress', $family->HomeAddress)); ?>" class="form-input">
            </div>
            <div>
                <label class="form-label">Phone Number</label>
                <input type="text" name="PhoneNumber" value="<?php echo e(old('PhoneNumber', $family->PhoneNumber)); ?>" class="form-input">
            </div>
        </div>
...
<?php echo $__env->make('admin.Layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\admin\People\Families\edit.blade.php ENDPATH**/ ?>