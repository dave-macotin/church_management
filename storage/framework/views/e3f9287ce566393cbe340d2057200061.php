...
<?php $__env->startSection('title', 'Add Member — Grace Church CMS'); ?>
...
<div class="card p-6 max-w-2xl">
    ...
    <form method="POST" action="<?php echo e(route('admin.members.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="form-label">First Name <span style="color:var(--red)">*</span></label>
                <input type="text" name="FirstName" value="<?php echo e(old('FirstName')); ?>" class="form-input" required>
            </div>
            <div>
                <label class="form-label">Last Name <span style="color:var(--red)">*</span></label>
                <input type="text" name="LastName" value="<?php echo e(old('LastName')); ?>" class="form-input" required>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="FamilyID" class="form-input">
                    ...
                    <?php $__currentLoopData = $families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($family->FamilyID); ?>" <?php echo e(old('FamilyID') == $family->FamilyID ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <select name="RoleID" class="form-input">
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($role->RoleID); ?>" <?php echo e(old('RoleID') == $role->RoleID ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.Layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\admin\People\Members\create.blade.php ENDPATH**/ ?>