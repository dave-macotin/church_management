...
<div class="flex items-center gap-3 mb-6">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-ghost" style="padding:0.4rem 0.8rem">
    ...
    <div>
        <h1 class="font-cinzel text-xl font-semibold" style="color:var(--gold-mid)">Admin Profile</h1>
        <p class="text-sm" style="color:var(--gold-muted)">Manage your administrator details</p>
    </div>
</div>
...
<div class="profile-grid">
    ...
    <div style="display:flex; flex-direction:column; gap:24px;">
        <div class="card" style="padding:32px 24px; text-align:center;">
                <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST" id="avatarForm" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    
                    
                    <input type="hidden" name="name" value="<?php echo e($user->name); ?>">
                    <input type="hidden" name="email" value="<?php echo e($user->email); ?>">
                    <input type="hidden" name="first_name" value="<?php echo e($member?->FirstName); ?>">
                    <input type="hidden" name="last_name" value="<?php echo e($member?->LastName); ?>">
                    <input type="hidden" name="phone_number" value="<?php echo e($member?->PhoneNumber); ?>">
                    <input type="hidden" name="date_of_birth" value="<?php echo e($member?->DateOfBirth ? $member->DateOfBirth->format('Y-m-d') : ''); ?>">
                    ...
                    <div class="avatar-preview" id="imagePreview">
                        <?php if($avatarUrl): ?>
                            ...
                            <a href="<?php echo e($avatarUrl); ?>" download="profile_picture_<?php echo e($user->id); ?>.jpg" class="avatar-action avatar-download" title="Download Profile Picture">
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views/admin/profile/edit.blade.php ENDPATH**/ ?>