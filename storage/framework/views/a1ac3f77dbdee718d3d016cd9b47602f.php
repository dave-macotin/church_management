    ...
    <div class="events-grid">
        ...
        <div class="card event-card flex flex-col">
            ...
            <div class="event-body flex-1 flex flex-col p-6">
                ...
                <h3 class="font-cinzel text-lg text-cream mb-3 leading-snug"><?php echo e($event->Title); ?></h3>
                <div class="text-sm text-gold-muted flex items-center gap-2 mb-6">
                    ...
                    <?php echo e($event->Location ?? 'Grace Church'); ?>
                        ...
                        <?php elseif(!$attendance->CheckOutTime): ?>
                            <div class="flex flex-col gap-3">
                                <div class="flex flex-col gap-1 p-3 rounded-lg border border-green-500/20 bg-green-500/5">
                                    ...
                                    <div class="text-xs text-cream/70">Joined at <?php echo e($attendance->CheckInTime->format('g:i A')); ?></div>
                                </div>
                        ...
                        <?php else: ?>
                            <div class="p-4 rounded-xl bg-gold-bright/5 border border-white/5 flex flex-col gap-3">
                                ...
                                <div class="flex justify-between items-center text-[11px] text-cream/60">
                                    <span><?php echo e($attendance->CheckInTime->format('g:i A')); ?></span>
                                    ...
                                    <span><?php echo e($attendance->CheckOutTime->format('g:i A')); ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
        ...
        <div class="data-table-container">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="font-medium text-cream"><?php echo e($event->Title); ?></td>
                        <td class="text-gold-muted"><?php echo e($event->StartDateTime->format('M d, Y')); ?></td>
                        <td class="text-gold-muted"><?php echo e($event->Location ?? '—'); ?></td>
                    </tr>
