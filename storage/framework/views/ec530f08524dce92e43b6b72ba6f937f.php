    ...
    <table>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td style="color:var(--text-muted)"><?php echo e($member->Email ?? '—'); ?></td>
                <td style="color:var(--text-muted)"><?php echo e($member->PhoneNumber ?? '—'); ?></td>
                ...
                <td style="color:var(--text-muted)"><?php echo e($member->created_at?->format('M d, Y')); ?></td>
                <td>
                    <div class="flex items-center gap-2 justify-end">
                        <a href="<?php echo e(route('admin.members.edit', $member)); ?>" class="btn btn-ghost" style="padding:0.35rem 0.7rem;font-size:0.8rem">Edit</a>
