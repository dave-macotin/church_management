...
<?php $__env->startSection('title', 'Edit Attendance — Grace Church CMS'); ?>
...
<div class="card p-6 max-w-md">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.attendance.update', $attendance)); ?>">
        ...
        <div class="flex flex-col gap-4">
                ...
                <select name="MemberID" class="form-input" required>
                    ...
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($member->MemberID); ?>"
                            <?php echo e(old('MemberID', $attendance->MemberID) == $member->MemberID ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <select name="Status" class="form-input" required>
                    ...
                    <option value="Excused" <?php echo e(old('Status', $attendance->Status) === 'Excused' ? 'selected' : ''); ?>>Excused</option>
                </select>
            </div>
            <div>
                <label class="form-label">Date & Time <span style="color:var(--red)">*</span></label>
                <input type="datetime-local" name="Timestamp"
                       value="<?php echo e(old('Timestamp', $attendance->Timestamp?->format('Y-m-d\TH:i'))); ?>"
...
<?php echo $__env->make('admin.Layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\admin\Ministry\Attendance\edit.blade.php ENDPATH**/ ?>