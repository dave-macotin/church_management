...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> — Grace Church CMS</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-logo">
            ...
            <div class="logo-text">
                ...
                <span class="logo-sub"><?php echo e(App\Models\Setting::get('church_motto', 'Management System')); ?></span>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Overview</div>
            <a href="<?php echo e(route('member.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('member.dashboard') ? 'active' : ''); ?>">
                <span class="nav-icon">
            ...
            <a href="<?php echo e(route('member.profile')); ?>" class="nav-item <?php echo e(request()->routeIs('member.profile') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.attendance')); ?>" class="nav-item <?php echo e(request()->routeIs('member.attendance') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.events')); ?>" class="nav-item <?php echo e(request()->routeIs('member.events') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.groups')); ?>" class="nav-item <?php echo e(request()->routeIs('member.groups') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.family')); ?>" class="nav-item <?php echo e(request()->routeIs('member.family') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.children.index')); ?>" class="nav-item <?php echo e(request()->routeIs('member.children.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('sermons.index')); ?>" class="nav-item <?php echo e(request()->routeIs('sermons.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.volunteering.index')); ?>" class="nav-item <?php echo e(request()->routeIs('member.volunteering.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
            ...
            <a href="<?php echo e(route('member.donations')); ?>" class="nav-item <?php echo e(request()->routeIs('member.donations') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                ...
                <div class="user-info">
                    <span class="user-name"><?php echo e(auth()->user()->first_name ?? 'Member'); ?></span>
...
<?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\member\layout\app.blade.php ENDPATH**/ ?>