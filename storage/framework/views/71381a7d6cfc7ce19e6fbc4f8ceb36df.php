                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center gap-2 justify-end">
                            <a href="<?php echo e(route('staff.members.show', $member)); ?>" class="btn btn-ghost btn-sm">View</a>
                            <a href="<?php echo e(route('staff.members.edit', $member)); ?>" class="btn btn-ghost btn-sm">Edit</a>
                        </div>
                    </td>
                </tr>
