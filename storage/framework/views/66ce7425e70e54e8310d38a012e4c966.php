        ...
        <div class="card" style="padding:32px 24px; text-align:center;">
            <form action="<?php echo e(route('member.profile.update')); ?>" method="POST" id="avatarForm" enctype="multipart/form-data">
                ...
                <div class="avatar-upload">
                    <div class="avatar-preview" id="imagePreview" style="<?php echo e($member->profile_picture ? 'background-image:url('.asset('storage/'.$member->profile_picture).');' : ''); ?>">
                        <?php if(!$member->profile_picture): ?>
                            <span style="font-size:64px; font-family:Georgia, serif; color:var(--gold-muted);"><?php echo e(strtoupper(substr($member->FirstName, 0, 1))); ?></span>
                        <?php endif; ?>
                    </div>
            ...
            <div style="display:flex; justify-content:center; gap:8px;">
                <span style="background:var(--accent-glow); color:var(--gold-bright); font-size:10px; padding:4px 10px; border-radius:99px; border:1px solid rgba(216,90,48,0.2);"><?php echo e($member->role->RoleName ?? 'Member'); ?></span>
            </div>
        </div>
