...
<form method="GET" action="<?php echo e(route('admin.expenses.index')); ?>" class="mb-6">
        ...
        <table>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="color:var(--gold-muted)">#<?php echo e($expense->ExpenseID); ?></td>
                        <td><span class="badge badge-muted"><?php echo e($expense->Category ?? 'Uncategorized'); ?></span></td>
                        <td><span class="text-cream font-medium"><?php echo e($expense->Vendor ?? '—'); ?></span></td>
                        <td><span class="font-bold text-gold-bright">₱<?php echo e(number_format($expense->Amount, 2)); ?></span></td>
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.expenses.edit', $expense)); ?>" class="btn btn-ghost btn-sm">
                                    Edit
                                </a>
