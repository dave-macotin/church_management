<?php $__env->startSection('title', 'Edit Expense — Grace Church CMS'); ?>
...
<div class="flex items-center gap-3 mb-6">
    ...
    <h1 class="font-cinzel text-2xl" style="color:var(--gold)">Edit Expense</h1>
</div>
...
<div class="card p-6 max-w-xl">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.expenses.update', $expense)); ?>">
        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
        <div class="flex flex-col gap-4">
            <div>
                <label class="form-label">Category</label>
                <input type="text" name="Category" value="<?php echo e(old('Category', $expense->Category)); ?>" class="form-input">
            </div>
            <div>
                <label class="form-label">Amount <span style="color:var(--red)">*</span></label>
                <input type="number" step="0.01" name="Amount" value="<?php echo e(old('Amount', $expense->Amount)); ?>" class="form-input" required min="0">
            </div>
            <div>
                <label class="form-label">Vendor / Payee</label>
                <input type="text" name="Vendor" value="<?php echo e(old('Vendor', $expense->Vendor)); ?>" class="form-input">
            </div>
            <div>
                ...
                <select name="EventID" class="form-input">
                    ...
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($event->EventID); ?>"
                            <?php echo e(old('EventID', $expense->EventID) == $event->EventID ? 'selected' : ''); ?>>
        ...
        <div class="flex gap-3 mt-6">
            <button type="submit" class="btn btn-gold">Update Expense</button>
...
<?php echo $__env->make('admin.Layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\admin\Finance\Expenses\edit.blade.php ENDPATH**/ ?>