<?php $__env->startSection('title', 'Event Details — Grace Church Staff'); ?>

<?php $__env->startSection('content'); ?>
<div class="flex items-center gap-3 mb-6">
    <a href="<?php echo e(route('staff.events.index')); ?>" class="btn btn-ghost" style="padding:0.4rem 0.8rem">
    ...
    <div>
        ...
        <p class="text-sm" style="color:var(--gold-muted)"><?php echo e($event->Title); ?></p>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="md:col-span-1 space-y-6">
        <div class="card overflow-hidden">
            <?php if($event->image): ?>
                <img src="<?php echo e(asset('storage/' . $event->image)); ?>" class="w-full h-48 object-cover">
            <?php else: ?>
            ...
            <?php endif; ?>
            <div class="p-6">
                <h2 class="text-xl font-bold mb-4" style="color:var(--gold-mid)"><?php echo e($event->Title); ?></h2>
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="mt-1">
                            ...
                            <?php elseif($event->StartDateTime && $event->StartDateTime->isFuture()): ?>
                    ...
                    <div>
                        ...
                        <div class="text-sm"><?php echo e($event->Location ?? 'No location set'); ?></div>
                    </div>
                    <div>
                        <label class="text-[10px] uppercase font-bold tracking-tighter" style="color:var(--gold-muted)">Start Time</label>
                        <div class="text-sm font-medium"><?php echo e($event->StartDateTime?->format('F d, Y — g:i A') ?? 'N/A'); ?></div>
                    </div>
                    <div>
                        <label class="text-[10px] uppercase font-bold tracking-tighter" style="color:var(--gold-muted)">End Time</label>
                        <div class="text-sm font-medium"><?php echo e($event->EndDateTime?->format('F d, Y — g:i A') ?? 'N/A'); ?></div>
                    </div>
                </div>
                
                <div class="mt-6">
                     <a href="<?php echo e(route('staff.events.edit', $event)); ?>" class="btn btn-gold w-full text-xs">Edit Event</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="md:col-span-2 space-y-6">
        <div class="card overflow-hidden">
            <div class="panel-header">
                <h3 class="panel-title">Linked Groups (<?php echo e($event->groups->count()); ?>)</h3>
            </div>
             <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-white/5">
                    <?php $__currentLoopData = $event->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="p-4 font-medium text-sm"><?php echo e($group->GroupName); ?></td>
                            <td class="p-4 text-xs text-muted"><?php echo e(Str::limit($group->Description, 50)); ?></td>
                            <td class="p-4 text-right">
                                <a href="<?php echo e(route('staff.groups.show', $group)); ?>" class="text-gold text-xs hover:underline">View Group</a>
                            </td>
                        </tr>
        ...
        <div class="card overflow-hidden">
            ...
            <div class="p-6 text-center">
                 <?php $presentCount = $event->attendance->where('Status', 'Present')->count(); ?>
                 <div class="text-4xl font-bold text-gold mb-2"><?php echo e($presentCount); ?></div>
                 <div class="text-xs uppercase tracking-widest text-muted">Total Checked In</div>
                 <div class="mt-6">
                      <a href="<?php echo e(route('staff.attendance.index', ['date' => $event->StartDateTime?->format('Y-m-d')])); ?>" class="btn btn-ghost text-xs">View Full Attendance List</a>
                 </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('staff.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\staff\events\show.blade.php ENDPATH**/ ?>