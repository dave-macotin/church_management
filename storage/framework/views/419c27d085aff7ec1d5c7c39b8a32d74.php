            ...
            <div class="p-5 flex-1 flex flex-col">
                ...
                <div class="mt-auto pt-4 border-t border-white/5 flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('staff.events.show', $event)); ?>" class="text-[10px] font-bold text-gold-bright hover:text-gold-mid transition-colors uppercase tracking-wider">Details</a>
                        <a href="<?php echo e(route('staff.events.edit', $event)); ?>" class="text-[10px] font-bold text-gold-bright/60 hover:text-gold-mid transition-colors uppercase tracking-wider">Modify</a>
                    </div>
                </div>
            </div>
        </div>
