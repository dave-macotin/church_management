...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="card p-6 flex flex-col justify-center border-l-4 border-gold-bright">
            ...
            <div class="font-cinzel text-2xl font-bold text-gold-bright">₱<?php echo e(number_format($totalDonations, 2)); ?></div>
        </div>
        <div class="card p-6 flex flex-col justify-center border-l-4 border-gold-muted/30">
            ...
            <div class="font-cinzel text-2xl font-bold text-cream"><?php echo e($donationCount); ?></div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="data-table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-cream text-sm"><?php echo e(\Carbon\Carbon::parse($donation->Date)->format('M d, Y')); ?></td>
                                <td><span class="badge badge-muted"><?php echo e($donation->FundCategory); ?></span></td>
                                <td class="text-gold-muted text-xs"><?php echo e($donation->PaymentMethod ?? '—'); ?></td>
                                <td class="text-right font-bold text-gold-bright">₱<?php echo e(number_format($donation->Amount, 2)); ?></td>
                                <td class="text-center">
                                    <a href="<?php echo e(route('member.donations.receipt', $donation->DonationID)); ?>" target="_blank" class="btn btn-ghost btn-xs">
        ...
        <div class="space-y-6">
            <div class="card p-6">
                ...
                <div class="space-y-6">
                    <?php $__empty_1 = true; $__currentLoopData = $fundBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-[11px] font-bold text-gold-muted uppercase tracking-wider"><?php echo e($fb['name']); ?></span>
                            <span class="text-sm font-bold text-cream">₱<?php echo e(number_format($fb['amount'], 0)); ?></span>
                        </div>
                        <?php $percent = $totalDonations > 0 ? ($fb['amount'] / $totalDonations) * 100 : 0; ?>
                        <div class="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                            <div class="h-full bg-gold-bright rounded-full transition-all duration-1000" style="width:<?php echo e($percent); ?>%;"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div id="donateModal" style="display:none;" class="fixed inset-0 bg-black/80 z-[2000] backdrop-blur-sm flex items-center justify-center p-4">
        <div class="card w-full max-w-md p-8 shadow-2xl relative border-gold-bright/20">
            ...
            <form action="<?php echo e(route('member.donations.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                <div>
