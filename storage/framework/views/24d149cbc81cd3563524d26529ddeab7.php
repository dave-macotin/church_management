            ...
            <div class="field-row">
                <div class="field-group">
                    ...
                    <input
                        ...
                        type="text"
                        name="first_name"
                        class="field-input <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field-group">
                    ...
                    <input
                        ...
                        type="text"
                        name="last_name"
                        class="field-input <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="field-error" style="display:block; margin-top:-14px; margin-bottom:14px;"><?php echo e($message); ?></span>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\auth\register.blade.php ENDPATH**/ ?>