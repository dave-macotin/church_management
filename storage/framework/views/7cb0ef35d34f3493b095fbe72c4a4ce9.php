...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        #searchResults::-webkit-scrollbar-thumb { background: var(--border); border-radius: 4px; }
    </style>
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                <div class="user-avatar" style="<?php echo e(auth()->user()->member?->profile_picture ? 'background-image:url('.asset('storage/'.auth()->user()->member->profile_picture).'); color:transparent;' : ''); ?>">
                   <?php echo e(!auth()->user()->member?->profile_picture ? strtoupper(substr(auth()->user()->name ?? 'A', 0, 1)) : ''); ?>
        ...
        <header class="topbar">
            ...
            <div class="flex-1 max-w-md mx-4 relative hidden md:block">
                <div class="relative">
                    ...
                    <input type="text" id="globalSearchInput" placeholder="Quick Search (Ctrl+K)" class="form-input !pl-10 !py-1.5 text-sm" autocomplete="off">
                </div>
