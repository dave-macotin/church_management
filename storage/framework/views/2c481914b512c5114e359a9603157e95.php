...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', App\Models\Setting::get('church_name', 'Grace Church') . ' — Staff'); ?></title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .user-avatar {
            ...
            height: 32px;
            border-radius: 50%;
            background: linear-gradient(135deg, var(--accent) 0%, var(--gold-bright) 100%);
        ...
        .form-input:focus { border-color: var(--gold-bright); }
...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-logo">
            ...
            <div class="logo-text">
                ...
                <span class="logo-sub">Staff Portal</span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('staff.members.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.members.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.families.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.families.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.groups.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.groups.*') ? 'active' : ''); ?>">
                <span class="nav-icon"><svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg></span>
                <span class="nav-label">Groups</span>
            </a>

            <div class="nav-section-label">Ministry</div>
            <a href="<?php echo e(route('staff.events.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.events.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.attendance.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.attendance.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.sermons.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.sermons.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.checkin.kiosk')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.checkin.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('staff.volunteering.index')); ?>" class="nav-item <?php echo e(request()->routeIs('staff.volunteering.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                <div class="user-avatar" style="<?php echo e(auth()->user()->member?->profile_picture ? 'background-image:url('.asset('storage/'.auth()->user()->member->profile_picture).'); color:transparent;' : ''); ?>">
                   <?php echo e(!auth()->user()->member?->profile_picture ? strtoupper(substr(auth()->user()->name ?? 'S', 0, 1)) : ''); ?>

                </div>
                <div class="user-info">
                    <span class="user-name"><?php echo e(auth()->user()->name ?? 'Staff'); ?></span>
                    <span class="user-role">Church Staff</span>
                </div>
            </div>
        </div>
    </aside>
    ...
    <div class="main-area">
        <header class="topbar">
            ...
            <span class="topbar-title"><?php echo $__env->yieldContent('page_title', 'Staff Portal'); ?></span>
...
<script>
    ...
    const STORAGE_KEY = 'grace_sidebar_collapsed_staff';
...
<?php /**PATH C:\Users\Lenovo\Desktop\laravel\churchmgt\resources\views\staff\layout\app.blade.php ENDPATH**/ ?>