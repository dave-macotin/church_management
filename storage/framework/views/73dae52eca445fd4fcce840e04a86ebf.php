            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="rate-display">
                        ...
                        <div class="rate-label"><?php echo e($attendanceRate); ?>%</div>
                        <div class="rate-sub">Overall rate</div>
                    </div>
                    <div class="rate-breakdown">
                        <div class="rate-item p"><div class="val"><?php echo e($presentCount); ?></div><div class="lbl">Present</div></div>
                        <div class="rate-item a"><div class="val"><?php echo e($absentCount); ?></div><div class="lbl">Absent</div></div>
                        <div class="rate-item e"><div class="val"><?php echo e($excusedCount); ?></div><div class="lbl">Excused</div></div>
                    </div>
                </div>
            </div>
