...
<div class="card overflow-hidden">
    <table>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="font-semibold"><?php echo e($group->GroupName); ?></td>
                <td style="color:var(--text-muted);max-width:280px">
                    <?php echo e($group->Description ? Str::limit($group->Description, 80) : '—'); ?>

                </td>
                <td><?php echo e($group->event?->Title ?? '—'); ?></td>
                <td style="color:var(--text-muted)"><?php echo e($group->created_at?->format('M d, Y')); ?></td>
                <td>
                    <div class="flex items-center gap-2 justify-end">
                        <a href="<?php echo e(route('admin.groups.edit', $group)); ?>" class="btn btn-ghost" style="padding:0.35rem 0.7rem;font-size:0.8rem">Edit</a>
