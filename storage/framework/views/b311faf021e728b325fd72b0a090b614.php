        ...
        <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td>
                    ...
                    <?php else: ?>
                        <span class="text-xs" style="color:var(--text-muted);font-style:italic">No time logs</span>
                    <?php endif; ?>
                </td>
                <td style="color:var(--text-muted)"><?php echo e($att->Timestamp?->format('M d, Y') ?? '—'); ?></td>
                <td style="text-align:right">
                    <form method="POST" action="<?php echo e(route('admin.attendance.archive', $att)); ?>"
                        ...
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="btn btn-ghost" style="padding:0.35rem 0.7rem;font-size:0.8rem;color:var(--amber);border-color:var(--amber)"
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr>
                <td colspan="6" class="text-center py-12" style="color:var(--text-muted)">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" style="width:40px;height:40px;margin:0 auto 0.75rem;opacity:0.4"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
